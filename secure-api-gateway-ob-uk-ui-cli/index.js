...
module.exports = () => {
  ...
  if (!args._[0] || args.help || args.h) {
    const menus = {
      main: `
            secure-api-gateway-ob-uk-ui-cli [command] <options>
        ...
        `,
      addTheme: `
            secure-api-gateway-ob-uk-ui-cli addTheme <options>

            --name          ..... the theme name
            --customization ..... the customization file path
        `,
      buildThemes: `
            secure-api-gateway-ob-uk-ui-cli buildThemes <options>

            --project ..... the app name
        `,
      appSize: `
            secure-api-gateway-ob-uk-ui-cli appSize <options>
