...
import { DomesticSchedulePaymentComponent } from './domestic-schedule-payment.component';
import {ConsentDecision} from "../../../types/ConsentDecision";

describe('app:bank DomesticSchedulePaymentComponent', () => {
  let component: DomesticSchedulePaymentComponent;
  let fixture: ComponentFixture<DomesticSchedulePaymentComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [DomesticSchedulePaymentComponent, PermissionsComponent],
      imports: [
        CommonModule,
        MatSharedModule,
