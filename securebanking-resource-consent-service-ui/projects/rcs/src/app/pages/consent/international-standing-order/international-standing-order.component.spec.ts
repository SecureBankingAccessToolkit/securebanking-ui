...
import { InternationalStandingOrderComponent } from './international-standing-order.component';

describe('app:bank InternationalStandingOrderComponent', () => {
  let component: InternationalStandingOrderComponent;
  let fixture: ComponentFixture<InternationalStandingOrderComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [InternationalStandingOrderComponent, PermissionsComponent],
      imports: [
        CommonModule,
        MatSharedModule,
